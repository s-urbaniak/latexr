...
latex(
  ...
  rowlabel="",
  rowlabel.just="r", 
  rgroup = c("Migrationshintergrund", "Sprachgebrauch zu Hause", "Bildungsniveau der Eltern"),
  n.rgroup=c(3, 2, NROW(tabelle)-5), 
  booktabs = TRUE,
  rowname = latexTranslate(rownames(tabelle)),
  caption="Hallo Welt!"
)
@
