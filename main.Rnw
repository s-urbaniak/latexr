...
\title{Einfluss des Migrationshintergrundes auf die Lesekompetenz der Jugendlichen unter Berücksichtigung der ausgewählten Merkmale des kulturellen Kapitals}
